...
def main():
    resnet50_features = VGGFace(model='resnet50', include_top=True, input_shape=(224, 224, 3),
    ...
    FACE_IMAGES_FOLDER = "C:/Users/HP/vggface2/data/face_images"
    VIDEOS_FOLDER = "C:/Users/HP/vggface2/data/videos"
    """
